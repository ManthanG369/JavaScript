...
// console.log(id === anotherId); // * false symbol gives unique value

const bigNumber = 140757597597975907n;
// Refrence Non Primitive   in memory refrence is given

// Array , Object , Functions

const hero = ["shaktiman", "naagraj", "hatim"];
